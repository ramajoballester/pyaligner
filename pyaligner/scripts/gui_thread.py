...
class PyalignerGUI(QMainWindow):
    ...
    def __init__(self):
        ...
        # self.aligner_thread = AlignerThread(self.input_folder)
    ...
    def align(self):
        if self.input_folder:
            ...
            # self.aligner_thread.folder_path = self.input_folder
            # self.aligner_thread.start()

            aligner_thread.align_action(self.args, 
    ...
    def auto(self):
        if self.input_folder:
            ...
            # aligner_thread.auto_action(self.args, 
            #                            self.progress_signal, 
            #                            self.error_signal)
    ...
    def transcribe(self):
        if self.input_folder:
            ...
            aligner_thread.transcribe_action(self.args, 
                                             self.progress_signal, 
                                             self.error_signal)
